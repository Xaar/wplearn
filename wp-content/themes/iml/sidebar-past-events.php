...
<div class='events-rightcol-wrapper alignright'>
  <div id="upcoming-events">
    <h2>PAST EVENTS</h2>
<?php
$wp_query = new WP_Query( array ( 'post_type' => 'news-events', 'posts_per_page' => 6, 'meta_key' => 'event_end_date', 'meta_compare' => '<', 'meta_value' => date('Ymd'), 'orderby' => 'meta_value', 'order' => 'ASC'));
$i=0;
